...
function buildPrompt(names) {
    ...
    return [
        ...
        "- No hagas resúmenes ni interpretaciones, no omitas nada que se diga en el audio. Transcribe todo lo que se diga, aunque sea irrelevante o repetitivo.",
        ...
        "- Corrige muletillas y frases cortadas, pero no omitas nada.",
